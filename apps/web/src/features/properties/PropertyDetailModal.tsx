      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-200 dark:border-slate-800">
          <div>
            ...
            <h2 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">{property.address}</h2>
        ...
        <div className="space-y-2">
          <div className="relative aspect-[16/9] rounded-2xl overflow-hidden bg-slate-50 dark:bg-slate-950 shadow-inner">
            <img
        ...
        <div className="p-5 bg-slate-50 dark:bg-slate-950/80 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-y-3 gap-x-4 text-xs">
            <div>
              ...
              <span className="font-semibold text-slate-800 dark:text-slate-200">{property.propertyType}</span>
            </div>
            <div>
            ...
            <div>
              ...
              <span className="font-semibold text-slate-800 dark:text-slate-200">{property.rooms} ({property.bedrooms || 1} bed)</span>
            </div>
            <div>
            ...
            <div>
              ...
              <span className="font-semibold text-slate-800 dark:text-slate-200">{property.energyClass || "E2018"}</span>
            </div>
            <div>
              <span className="text-slate-500 block">Sauna</span>
              <span className="font-semibold text-slate-800 dark:text-slate-200">{property.hasSauna ? "Yes (Oma sauna)" : "No"}</span>
            </div>
            <div>
              <span className="text-slate-500 block">Balcony</span>
              <span className="font-semibold text-slate-800 dark:text-slate-200">{property.hasBalcony ? "Yes (Parveke)" : "No"}</span>
            </div>
            <div>
              <span className="text-slate-500 block">Elevator</span>
              <span className="font-semibold text-slate-800 dark:text-slate-200">{property.hasElevator ? "Yes (Hissi)" : "No"}</span>
            </div>
            <div>
              <span className="text-slate-500 block">Postal Code</span>
              <span className="font-semibold text-slate-800 dark:text-slate-200">{property.postalCode ? `${property.postalCode} ${property.city}` : property.city}</span>
            </div>
            <div>
              <span className="text-slate-500 block">Provider</span>
              <span className="font-semibold text-slate-800 dark:text-slate-200">{property.provider}</span>
            </div>
          </div>
        </div>

        {/* Description */}
        <div className="p-4 bg-slate-50 dark:bg-slate-950/80 rounded-xl text-xs text-slate-700 dark:text-slate-300 leading-relaxed border border-slate-200 dark:border-slate-800">
